  ...
  Container(
    ...
    Container(
      ...
      children: <Widget>[
        ...
        Padding(padding: EdgeInsets.only(left: 8),child: Row(children: <Widget>[Icon(Icons.print),Padding(padding: EdgeInsets.only(left: 8),child: Text("强力推荐作品"),),],)),

        
        Padding(padding: EdgeInsets.only(right: 10),child: Icon(Icons.arrow_forward),)
      ],
    )),

    GridView.builder(
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,mainAxisSpacing: 10,crossAxisSpacing: 5,childAspectRatio: 1.3),
        itemCount: 4,
