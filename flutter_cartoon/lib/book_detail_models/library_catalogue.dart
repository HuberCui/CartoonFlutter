...
class Library_Catalogue{
  ...
  List imHightArr;
  Library_Catalogue(this.pass_time,this.type,this.name,this.chapter_id,this.crop_zip_size,this.has_locked_image,this.image_total,this.imHightArr,this.is_new,this.price,this.size,this.zip_high_webp);
}